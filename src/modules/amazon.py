...
from src.localuseragent import *
...
class Amazon(Module):
    async def run(
        ...
        headers = {"User-agent": choice(ua["browsers"]["chrome"])}
        try:
            ...
            req = await client.post(f"https://www.amazon.com/ap/signin/", data=data)  # type: ignore
            body = BeautifulSoup(req.text, "html.parser")
